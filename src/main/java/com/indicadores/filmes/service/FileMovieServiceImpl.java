...
@Service
public class FileMovieServiceImpl implements FileMovieService {
    private static final String CSV_FILE_PATH = "data/movielist.csv";
    private final MovieRepository movieRepository;
    private final ResourceLoader resourceLoader;

    @Autowired
    public FileMovieServiceImpl(MovieRepository movieRepository, ResourceLoader resourceLoader) {
     ...
     */
    public void importMoviesFromCSV() throws IOException {
    ...
    private File getCsvFile() throws IOException {
        ...
        if (!resource.exists()) {
            throw new IOException("File csv not found: " + CSV_FILE_PATH);
        }
